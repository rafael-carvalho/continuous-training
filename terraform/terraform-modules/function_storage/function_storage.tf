...
variable "trigger_bucket_name" {
  type        = string
  description = "The name of the bucket where the function will be triggered."
}
...
locals {
  ...
  environment_variables = merge(
    ...
    {
      LOG_EXECUTION_ID = true # had to add this otherwise error would be thrown:  Error: Provider produced inconsistent final plan
    },
  )
