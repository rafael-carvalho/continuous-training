...
python3 "$project_root/pipeline/test_pipeline.py" \
  --artifact_registry_repo_kfp_uri="$ARTIFACT_REGISTRY_REPO_KFP_URI" \
  --bq_training_data_uri="$BQ_SAMPLE_TRAINING_DATA_URI" \
